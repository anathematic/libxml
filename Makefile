...
LIBXML2_SHA256 = "0b74e51595654f958148759cfef0993114ddccccbb6f31aee018f3558e8e2732"
...
priv/libxml2/lib/libxml2.a:
	...
	cd libxml2_build \
		&& $(CURL) http://xmlsoft.org/sources/libxml2-2.9.8.tar.gz \
		&& echo "$(LIBXML2_SHA256) *libxml2-2.9.8.tar.gz" | $(SHASUM) -c \
